...
def extract_tubelets(dname, gpu=-1, redo=False):
    ...
    model_dir = os.path.join(os.path.dirname(__file__), '../models/enhanced-detector/', dname)
    output_dir = os.path.join(os.path.dirname(__file__), '../results/enhanced-detector/', dname)
...
def frameAP(dname, th=0.5, redo=False):
    d = GetDataset(dname)
    dirname = os.path.join(os.path.dirname(__file__), '../results/enhanced-detector/', dname)
...
def frameMABO(dname, redo=False):
    d = GetDataset(dname)
    dirname = os.path.join( os.path.dirname(__file__), '../results/workflow-detection/', dname)
